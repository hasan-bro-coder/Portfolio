...
//   2 , // radius
//   0.8, // tube thickness
//   16, // radial segments (Lower for low-poly look)
//   32 // tubular segments
// );
...
// let currentGeometry = isMobile ? donutGeometry : geometry;
// let currentMaterial = isMobile ? toonMaterial : material
// let sphere = new Mesh(currentGeometry, currentMaterial);
// scene.add(sphere);
